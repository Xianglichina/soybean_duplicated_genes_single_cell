...
duplicated_gene_pairs<-read.csv("glyma_duplicated_pairs_unique_1213.csv")
duplicated_gene_pairs$Gene_Pair<-duplicated_gene_pairs$Combined
...
#early_nodule_filter_expression<-read.csv("expressed_early_nodule_filtere_pairs_expression_separated_raw.csv")
...
early_nodule_filter_transcriptional_drift<-early_nodule_filter %>%
  filter(coexpression > 0.9,
        log2FC_mean_tissue >= 1,
        log2FC_sd_tissue <1)
...
early_nodule_filter_transcriptional_drift$expression_type<-"transcriptional_drift"
early_nodule_filter_specialized$expression_type<-"specialized"
early_nodule_filter_diverged$expression_type<-"diverged"

early_nodule_expression_type<-rbind(early_nodule_filter_dosage_balance, early_nodule_filter_transcriptional_drift, early_nodule_filter_specialized, early_nodule_filter_diverged, early_nodule_filter_one_express)
...
#cotyledon_filter_expression<-read.csv("expressed_cotyledon_filtere_pairs_expression_separated_raw.csv")
...
cotyledon_filter_transcriptional_drift<-cotyledon_filter %>%
  filter(coexpression > 0.9,
        log2FC_mean_tissue >= 1,
        log2FC_sd_tissue <1)
...
cotyledon_filter_transcriptional_drift$expression_type<-"transcriptional_drift"
cotyledon_filter_specialized$expression_type<-"specialized"
cotyledon_filter_diverged$expression_type<-"diverged"

cotyledon_expression_type<-rbind(cotyledon_filter_dosage_balance, cotyledon_filter_transcriptional_drift, cotyledon_filter_specialized, cotyledon_filter_diverged, cotyledon_filter_one_express)
...
#load the normalized gene expression of gene pairs across different cell types within the tissue
#heart_filter_expression<-read.csv("expressed_heart_filtere_pairs_expression_separated_raw.csv")
...
heart_filter_transcriptional_drift<-heart_filter %>%
  filter(coexpression > 0.9,
        log2FC_mean_tissue >= 1,
        log2FC_sd_tissue <1)
...
heart_filter_transcriptional_drift$expression_type<-"transcriptional_drift"
heart_filter_specialized$expression_type<-"specialized"
heart_filter_diverged$expression_type<-"diverged"

heart_expression_type<-rbind(heart_filter_dosage_balance, heart_filter_transcriptional_drift, heart_filter_specialized, heart_filter_diverged, heart_filter_one_express)
...
#load the normalized gene expression of gene pairs across different cell types within the tissue
#globular_filter_expression<-read.csv("expressed_globular_filtere_pairs_expression_separated_raw.csv")
...
globular_filter_transcriptional_drift<-globular_filter %>%
  filter(coexpression > 0.9,
        log2FC_mean_tissue >= 1,
        log2FC_sd_tissue <1)
...
globular_filter_transcriptional_drift$expression_type<-"transcriptional_drift"
globular_filter_specialized$expression_type<-"specialized"
globular_filter_diverged$expression_type<-"diverged"

globular_expression_type<-rbind(globular_filter_dosage_balance, globular_filter_transcriptional_drift, globular_filter_specialized, globular_filter_diverged, globular_filter_one_express)
...
#load the normalized gene expression of gene pairs across different cell types within the tissue
#hypocotyl_filter_expression<-read.csv("expressed_hypocotyl_filtere_pairs_expression_separated_raw.csv")
...
hypocotyl_filter_transcriptional_drift<-hypocotyl_filter %>%
  filter(coexpression > 0.9,
        log2FC_mean_tissue >= 1,
        log2FC_sd_tissue <1)
...
hypocotyl_filter_transcriptional_drift$expression_type<-"transcriptional_drift"
hypocotyl_filter_specialized$expression_type<-"specialized"
hypocotyl_filter_diverged$expression_type<-"diverged"

hypocotyl_expression_type<-rbind(hypocotyl_filter_dosage_balance, hypocotyl_filter_transcriptional_drift, hypocotyl_filter_specialized, hypocotyl_filter_diverged, hypocotyl_filter_one_express)
...
#load the normalized gene expression of gene pairs across different cell types within the tissue
#root_filter_expression<-read.csv("expressed_root_filtere_pairs_expression_separated_raw.csv")
...
root_filter_transcriptional_drift<-root_filter %>%
  filter(coexpression > 0.9,
        log2FC_mean_tissue >= 1,
        log2FC_sd_tissue <1)
...
root_filter_transcriptional_drift$expression_type<-"transcriptional_drift"
root_filter_specialized$expression_type<-"specialized"
root_filter_diverged$expression_type<-"diverged"

root_expression_type<-rbind(root_filter_dosage_balance, root_filter_transcriptional_drift, root_filter_specialized, root_filter_diverged, root_filter_one_express)
...
#load the normalized gene expression of gene pairs across different cell types within the tissue
#early_maturation_filter_expression<-read.csv("expressed_early_maturation_filtere_pairs_expression_separated_raw.csv")
...
early_maturation_filter_transcriptional_drift<-early_maturation_filter %>%
  filter(coexpression > 0.9,
        log2FC_mean_tissue >= 1,
        log2FC_sd_tissue <1)
...
early_maturation_filter_transcriptional_drift$expression_type<-"transcriptional_drift"
early_maturation_filter_specialized$expression_type<-"specialized"
early_maturation_filter_diverged$expression_type<-"diverged"

early_maturation_expression_type<-rbind(early_maturation_filter_dosage_balance, early_maturation_filter_transcriptional_drift, early_maturation_filter_specialized, early_maturation_filter_diverged, early_maturation_filter_one_express)
...
#load the genes with cell type specifically expression 
early_nodule_ct_gene<-read.csv("updated_early_nodule_specific_genes.csv")

#examine the overlap with the cell type specifically expressed genes with the patterns that one expressed and the other not expressed, here are the gene pairs with the expressed genes overlapped with the ct-gene  
early_nodule_one_expressed_overlap_ct<-early_nodule_filter_one_expression_expressed[early_nodule_filter_one_expression_expressed$expressed %in%  intersect(early_nodule_ct_gene$geneID,early_nodule_filter_one_expression_expressed$expressed) ,]

#summarize the gene pair based on duplication status for the overlap situation
early_nodule_one_expressed_overlap_ct_summary <- early_nodule_one_expressed_overlap_ct %>%
  count(duplication_status)

#here is the number of expressed genes are the ct genes
early_nodule_one_expressed_overlap_ct_unique_genes<-length(unique(early_nodule_one_expressed_overlap_ct$expressed))

length(unique(early_nodule_filter_one_expression_expressed$expressed))
...
#load the genes with cell type specifically expression 
cotyledon_ct_gene<-read.csv("updated_cotyledon_specific_genes.csv")

#examine the overlap with the cell type specifically expressed genes with the patterns that one expressed and the other not expressed, here are the gene pairs with the expressed genes overlapped with the ct-gene  
cotyledon_one_expressed_overlap_ct<-cotyledon_filter_one_expression_expressed[cotyledon_filter_one_expression_expressed$expressed %in%  intersect(cotyledon_ct_gene$geneID,cotyledon_filter_one_expression_expressed$expressed) ,]

#summarize the gene pair based on duplication status for the overlap situation
cotyledon_one_expressed_overlap_ct_summary <- cotyledon_one_expressed_overlap_ct %>%
  count(duplication_status)

#here is the number of expressed genes are the ct genes
cotyledon_one_expressed_overlap_ct_unique_genes<-length(unique(cotyledon_one_expressed_overlap_ct$expressed))
```
...
#load the genes with cell type specifically expression 
heart_ct_gene<-read.csv("updated_heart_specific_genes.csv")

#examine the overlap with the cell type specifically expressed genes with the patterns that one expressed and the other not expressed, here are the gene pairs with the expressed genes overlapped with the ct-gene  
heart_one_expressed_overlap_ct<-heart_filter_one_expression_expressed[heart_filter_one_expression_expressed$expressed %in%  intersect(heart_ct_gene$geneID,heart_filter_one_expression_expressed$expressed) ,]

#summarize the gene pair based on duplication status for the overlap situation
heart_one_expressed_overlap_ct_summary <- heart_one_expressed_overlap_ct %>%
  count(duplication_status)

#here is the number of expressed genes are the ct genes
heart_one_expressed_overlap_ct_unique_genes<-length(unique(heart_one_expressed_overlap_ct$expressed))
```
...
#load the genes with cell type specifically expression 
globular_ct_gene<-read.csv("updated_globular_specific_genes.csv")

#examine the overlap with the cell type specifically expressed genes with the patterns that one expressed and the other not expressed, here are the gene pairs with the expressed genes overlapped with the ct-gene  
globular_one_expressed_overlap_ct<-globular_filter_one_expression_expressed[globular_filter_one_expression_expressed$expressed %in%  intersect(globular_ct_gene$geneID,globular_filter_one_expression_expressed$expressed) ,]

#summarize the gene pair based on duplication status for the overlap situation
globular_one_expressed_overlap_ct_summary <- globular_one_expressed_overlap_ct %>%
  count(duplication_status)

#here is the number of expressed genes are the ct genes
globular_one_expressed_overlap_ct_unique_genes<-length(unique(globular_one_expressed_overlap_ct$expressed))
```
...
#load the genes with cell type specifically expression 
hypocotyl_ct_gene<-read.csv("updated_hypocotyl_specific_genes.csv")

#examine the overlap with the cell type specifically expressed genes with the patterns that one expressed and the other not expressed, here are the gene pairs with the expressed genes overlapped with the ct-gene  
hypocotyl_one_expressed_overlap_ct<-hypocotyl_filter_one_expression_expressed[hypocotyl_filter_one_expression_expressed$expressed %in%  intersect(hypocotyl_ct_gene$geneID,hypocotyl_filter_one_expression_expressed$expressed) ,]

#summarize the gene pair based on duplication status for the overlap situation
hypocotyl_one_expressed_overlap_ct_summary <- hypocotyl_one_expressed_overlap_ct %>%
  count(duplication_status)

#here is the number of expressed genes are the ct genes
hypocotyl_one_expressed_overlap_ct_unique_genes<-length(unique(hypocotyl_one_expressed_overlap_ct$expressed))
```
...
#load the genes with cell type specifically expression 
root_ct_gene<-read.csv("updated_root_specific_genes.csv")

#examine the overlap with the cell type specifically expressed genes with the patterns that one expressed and the other not expressed, here are the gene pairs with the expressed genes overlapped with the ct-gene  
root_one_expressed_overlap_ct<-root_filter_one_expression_expressed[root_filter_one_expression_expressed$expressed %in%  intersect(root_ct_gene$geneID,root_filter_one_expression_expressed$expressed) ,]

#summarize the gene pair based on duplication status for the overlap situation
root_one_expressed_overlap_ct_summary <- root_one_expressed_overlap_ct %>%
  count(duplication_status)

#here is the number of expressed genes are the ct genes
root_one_expressed_overlap_ct_unique_genes<-length(unique(root_one_expressed_overlap_ct$expressed))
```
...
#load the genes with cell type specifically expression 
early_maturation_ct_gene<-read.csv("updated_early_maturation_specific_genes.csv")

#examine the overlap with the cell type specifically expressed genes with the patterns that one expressed and the other not expressed, here are the gene pairs with the expressed genes overlapped with the ct-gene  
early_maturation_one_expressed_overlap_ct<-early_maturation_filter_one_expression_expressed[early_maturation_filter_one_expression_expressed$expressed %in%  intersect(early_maturation_ct_gene$geneID,early_maturation_filter_one_expression_expressed$expressed) ,]

#summarize the gene pair based on duplication status for the overlap situation
early_maturation_one_expressed_overlap_ct_summary <- early_maturation_one_expressed_overlap_ct %>%
  count(duplication_status)

#here is the number of expressed genes are the ct genes
early_maturation_one_expressed_overlap_ct_unique_genes<-length(unique(early_maturation_one_expressed_overlap_ct$expressed))
```
...
merge_early_maturation_expression_type_final_duplication<-early_maturation_expression_type_final_all[,c(8,6,15)]
...
merge_root_expression_type_final_duplication<-root_expression_type_final_all[,c(8,6,15)]
colnames(merge_root_expression_type_final_duplication) <-c("Gene_Pair","Duplication_status","expression_type_root")

merge_hypocotyl_expression_type_final_duplication<-hypocotyl_expression_type_final_all[,c(8,6,15)]
colnames(merge_hypocotyl_expression_type_final_duplication) <-c("Gene_Pair","Duplication_status","expression_type_hypocotyl")

merge_early_nodule_expression_type_final_duplication<-early_nodule_expression_type_final_all[,c(8,6,15)]
...
merge_heart_expression_type_final_duplication<-heart_expression_type_final_all[,c(8,6,15)]
colnames(merge_heart_expression_type_final_duplication) <-c("Gene_Pair","Duplication_status","expression_type_heart")

merge_cotyledon_expression_type_final_duplication<-cotyledon_expression_type_final_all[,c(8,6,15)]
colnames(merge_cotyledon_expression_type_final_duplication) <-c("Gene_Pair","Duplication_status","expression_type_cotyledon")

merge_globular_expression_type_final_duplication<-globular_expression_type_final_all[,c(8,6,15)] 
...
#write.csv(combined_expression_patterns, "combined_expression_patterns.csv")


variables <- c(
  "not_expressed", "others", "mono-expressed",
  "dosage_balance", "transcriptional_drift", "diverged", "specialized"
)
...
counts_df <- combined_expression_patterns %>%
  ...
  mutate(
    ...
    transcriptional_drift_count = sum(c_across(starts_with("expression_type")) == "transcriptional_drift"),
...
summary_df <- counts_df %>%
  mutate(combination = paste(
    ...
    dosage_balance_count, transcriptional_drift_count, diverged_count,
...
write.csv(summary_df, "02032025_gene_expression_type_across_tissues_summary.csv")


# Select the top 109 rows since their counts greater than 100 
top_109 <- head(summary_df, 109)

#make the plots for these top 109 occurance 
ggplot(top_109, aes(x = reorder(combination, -frequency), y = frequency)) +
...
write.csv(summary_df_combination,"02172025_summary_df_combination.csv")
